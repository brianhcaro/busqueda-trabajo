...
const PROFILE = {
  ...
  marketSkills: [
    ...
    { name: 'xray', aliases: ['xray'], has: true, weight: 0.9 },
    { name: 'azure devops', aliases: ['azure devops', 'azure'], has: true, weight: 0.8 },
    ...
    { name: 'soapui', aliases: ['soapui', 'ready api', 'readyapi'], has: true, weight: 0.8 },
    { name: 'browserstack', aliases: ['browserstack'], has: true, weight: 0.8 },
